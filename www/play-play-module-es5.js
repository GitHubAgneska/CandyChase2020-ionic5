...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["play-play-module"], {
      ...
      _createClass(AddressesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userStatsService.getCurrentAddressesList().subscribe(function (data) {
            ...
            _this.addressList = data; // console.log('ADDRESS lIST==', this.addressList);
  ...
  function srcAppPlayCandyDetailsCandyDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_models_candy_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../shared/models/candy.model */
      ...
      _createClass(CandyDetailsComponent, [{
        ...
        value: function displayCandyInfo(candyId) {
          ...
          this.candyApiService.getCandyById(this.candyId).subscribe(function (response) {
            _this4.candyItem = Object.assign({}, response); // special check for 'gelatin' in the api's fr version of ingredients list
            // (for it is systematically missing in the en version in use)

            var containsGelatin = function containsGelatin() {
              return _this4.candyItem.ingredients_text_fr.includes('gélatine' || false);
            }; // console.log('containsGelatin==', containsGelatin());
            // glutenFree check ----


            if (_this4.candyItem.allergens_hierarchy.length > 0) {
            ...
            if (containsGelatin()) {
              _this4.candyItem.ingredients_tags.push('gelatin');
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                var _x = _step2.value;
                var animalProductsTerms = /dairy | milk | butter| eggs | honey/g;

                if (_x === 'gelatin' || containsGelatin()) {
                  if (_x.match(animalProductsTerms)) {
                    _this4.candyChecklist.vegan = false;
                  }

                  _this4.candyChecklist.vegetarian = false;
                } else {
                  _this4.candyChecklist.vegetarian = true;
                }
              } // additives check ---
            ...
            if (_this4.candyItem.additives_tags && _this4.candyItem.additives_tags.length > 0) {
              _this4.candyChecklist.additives = true;
            } // organic check ---


            if (_this4.candyItem.labels !== '' || _this4.candyItem.labels_hierarchy) {
              var terms = /bio | ab | biologique/g;

              if (_this4.candyItem.labels.match(terms)) {
                console.log('BIO');
                _this4.candyChecklist.organic = true;
              }
            } // allergens check ---


            if (_this4.candyItem.allergens_hierarchy.length > 0) {
              _this4.allergens = true;
            }
          });
        }
      }, {
  ...
  function srcAppPlayCandyListCandyListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_candy_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../services/candy-api.service */
    "./src/app/play/services/candy-api.service.ts");
    /* harmony import */
    ...
    var _shared_models_candy_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../shared/models/candy.model */
    "./src/app/shared/models/candy.model.ts");
    /* harmony import */


    var _shared_pipes_shorten_string_shorten_string__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../shared/pipes/shorten-string/shorten-string */
    "./src/app/shared/pipes/shorten-string/shorten-string.ts");
    /* harmony import */


    var _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../shared/services/user-stats.service */
    "./src/app/shared/services/user-stats.service.ts");
    /* harmony import */


    var _shared_services_local_storage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var CandyListComponent = /*#__PURE__*/function () {
      function CandyListComponent(candyApiService, localStorageService, userStatsService, shortenString, toastController, router, activatedRoute) {
        ...
        this.anim = 'assets/graphicMat/loading.gif'; // this.candyList$ =  this.candyApiService.getAllCandyFromApi();
      ...
      _createClass(CandyListComponent, [{
        ...
        key: "retrievePathOrigin",
        value: function retrievePathOrigin() {
          var _this5 = this;

          this.activatedRoute.paramMap.subscribe(function (param) {
            _this5.pathOrigin = param.get('origin'); // = 'startPlaying' || 'resumePlaying'
          });
          return this.pathOrigin;
        }
      }, {
        key: "loadCandyListFromApi",
        value: function loadCandyListFromApi() {
          this.candyList$ = this.candyApiService.getAllCandyFromApi(); // this.candyApiService.getAllCandyFromApi().subscribe(data => this.candyList = data );
          // this.localStorageService.setDataToStore(this.candyList);
        }
      }, {
        key: "loadCandyListFromLocalStorage",
        value: function loadCandyListFromLocalStorage() {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_candy_api_service__WEBPACK_IMPORTED_MODULE_3__["CandyApiService"], _shared_services_local_storage_service__WEBPACK_IMPORTED_MODULE_8__["LocalStorageService"], _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_7__["UserStatsService"], _shared_pipes_shorten_string_shorten_string__WEBPACK_IMPORTED_MODULE_6__["ShortenStringPipe"], _ionic_angular__WEBPACK_IMPORTED_MODULE_9__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], CandyListComponent);
    /***/
  },
    ...
    var ChallengesListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ChallengesListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userStatsService.getCurrentAchievedTreats().subscribe(function (treats) {
            _this6.achievedTreatsList = treats; // console.log('TREATS LIST=', this.achievedTreatsList);

            if (_this6.achievedTreatsList.length > 0) {
              _this6.achievedTreatsdisplay = true;
            }
          });
          this.userStatsService.getCurrentAchievedTricks().subscribe(function (tricks) {
            _this6.achievedTricksList = tricks; // console.log('TRICKS LIST=', this.achievedTricksList);

            if (_this6.achievedTricksList.length > 0) {
              _this6.achievedTricksdisplay = true;
            }
          });
        }
      }]);
  ...
  function srcAppPlayChallengesChallengesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_models_challenges_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../shared/models/challenges.model */
    "./src/app/shared/models/challenges.model.ts");
    /* harmony import */


    var _services_challenges_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var ChallengesComponent = /*#__PURE__*/function () {
      function ChallengesComponent(activatedRoute, userStatsService, challengesApiService, toastController, router) {
      ...
      _createClass(ChallengesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userStatsService.getCurrentTotalPoints().subscribe(function (data) {
            return _this7.totalPoints = data;
          });
          this.userStatsService.getCompletedChallengesCount().subscribe(function (data) {
            return _this7.completedChallengesCount = data;
          });
          this.getChoice(); // console.log('TOTAL POINTS before bonus==', this.totalPoints);
        }
      }, {
        ...
        value: function getChoice() {
          ...
          this.activatedRoute.paramMap.subscribe(function (param) {
            _this8.choice = param.get('choice');
          });
        }
      }, {
          ...
          if (this.choice === 'treat') {
            ...
            this.challengesApiService.getTreatsList().subscribe(function (data) {
              ...
              for (var i = 0; i < data.length; i++) {
                _this9.treats.push(data[i]);

                var randomTreat = _this9.treats[Math.floor(Math.random() * _this9.treats.length)];

                _this9.currentChallenge = randomTreat;
                _this9.currentChallenge.challengeDescription = randomTreat.treatDescription;
                _this9.currentChallenge.bonusPoints = randomTreat.bonusPoints;
                _this9.currentChallenge.challengeId = randomTreat.treatId;
                _this9.currentChallenge.challengeType = 'treat';
              } // console.log('triggeredTreatsList before update==', this.triggeredTreatsList);


              _this9.triggeredTreatsList.push(Object.assign({}, _this9.currentChallenge)); // console.log('triggeredTreatsList after update==', this.triggeredTreatsList);


              _this9.userStatsService.updateCurrentTriggeredTreats(_this9.triggeredTreatsList); // // console.log('TREATSLIST==', this.treats); // (3) [{…}, {…}, {…}]
              // console.log('CURRENT CHALLENGE==', {... this.currentChallenge } );


              return Object.assign({}, _this9.currentChallenge);
            });
          } else {
            ...
            this.challengesApiService.getTricksList().subscribe(function (data) {
              // tslint:disable-next-line: prefer-for-of
              for (var i = 0; i < data.length; i++) {
                _this9.tricks.push(data[i]);

                var randomTrick = _this9.tricks[Math.floor(Math.random() * _this9.tricks.length)];

                _this9.currentChallenge = randomTrick;
                _this9.currentChallenge.challengeDescription = randomTrick.trickDescription;
                _this9.currentChallenge.bonusPoints = randomTrick.bonusPoints;
                _this9.currentChallenge.challengeId = randomTrick.trickId;
                _this9.currentChallenge.challengeType = 'trick';
              }

              _this9.triggeredTricksList.push(Object.assign({}, _this9.currentChallenge));

              _this9.userStatsService.updateCurrentTriggeredTricks(_this9.triggeredTricksList); // console.log('CURRENT CHALLENGE==', {... this.currentChallenge } );
        ...
        key: "isDone",
        value: function isDone(currentChallenge) {
          this.completedChallengesCount += 1;
          this.userStatsService.updateCompletedChallengesCount(this.completedChallengesCount);
          this.currentChallenge = currentChallenge; // console.log('CURRENT IS DONE== ', this.currentChallenge);

          this.currentChallenge.challengeType = currentChallenge.challengeType; // console.log('CURRENT IS DONE TYPE==', this.currentChallenge.challengeType);
          ...
          this.presentToastBonusPoints(this.currentChallenge.bonusPoints, this.newTotalPoints); // console.log('CURRENT TRICKS LIST==', this.achievedTricksList);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_3__["UserStatsService"], _services_challenges_api_service__WEBPACK_IMPORTED_MODULE_5__["ChallengesApiService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], ChallengesComponent);
    /***/
  },
  ...
  function srcAppPlayMapMapComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MapComponent = /*#__PURE__*/function () {
      function MapComponent(geolocService, geolocation, toastController, userStatsService) {
        var _this10 = this;
        ...
        this.userStatsService.getCurrentAddressesList().subscribe(function (data) {
          return _this10.addressList = data;
        });
        this.age = this.geolocService.getAgeRange(); // console.log('user age= ', this.age);

        if (this.age === undefined) {
          this.age = 3;
        }

        this.allowedDistance = this.geolocService.findAllowedDistance(this.age); // console.log('dist= ', this.allowedDistance);
      }
      ...
      _createClass(MapComponent, [{
        ...
        value: function initMapWithParams() {
          ...
          this.geolocService.loadMapWithBounds(); // this.geolocService.loadMapWithoutBounds();
        }
      }, {
        key: "saveAddress",
        value: function saveAddress() {
          ...
          if (!this.coords) {
            this.geolocation.getCurrentPosition().then(function (data) {
              _this11.coords.lat = data.coords.latitude;
              _this11.coords["long"] = data.coords.longitude; // console.log('COORDS==', this.coords);
            });
          }
          ...
          if (this.addressList.length > 0) {
            ...
            this.addressList.forEach(function (element) {
              ...
              if (element.lat === _this11.newAddress.lat && element["long"] === _this11.newAddress["long"]) {
                _this11.presentToastWithOptions('Address already saved!');

                return;
              } else {
                _this11.newAddress.timestamp = Date.now();

                _this11.addressList.push(_this11.newAddress);

                _this11.userStatsService.updateCurrentAddressesList(_this11.addressList);

                _this11.presentToastWithOptions('Address saved to favorites');
              }
            });
          } else {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_services_geoloc_service__WEBPACK_IMPORTED_MODULE_2__["GeolocService"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__["Geolocation"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"], _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_4__["UserStatsService"]])], MapComponent);
    /***/
  },
    ...
    var CandyApiService = /*#__PURE__*/function () {
      ...
      _createClass(CandyApiService, [{
        ...
        value: function getAllCandyFromApi() {
          return this.httpService.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].candyListApi + this.resultPageSize)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
        ...
        value: function getCandyById(candyId) {
          return this.httpService.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].candyByIdApiUrl) + candyId + '.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
  ...
  function srcAppPlayUserStatsUserStatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_models_level_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../shared/models/level.model */
    "./src/app/shared/models/level.model.ts");
    /* harmony import */


    var _shared_pipes_keyvalue_keyvalue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../shared/pipes/keyvalue/keyvalue */
    "./src/app/shared/pipes/keyvalue/keyvalue.ts");
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_3__["UserStatsService"], _shared_pipes_keyvalue_keyvalue__WEBPACK_IMPORTED_MODULE_5__["KeyvaluePipe"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], UserStatsComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedModelsCandyModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CandyChecklist", function () {
    ...
    var Candy = function Candy(fields) {
    ...
    var CandyChecklist = function CandyChecklist() {
      _classCallCheck(this, CandyChecklist);
  ...
  /***/
  function srcAppSharedModelsChallengesModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TrickAndTreat", function () {
      return TrickAndTreat;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Trick", function () {
      return Trick;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Treat", function () {
      return Treat;
    });
    /* harmony import */
    ...
    var TrickAndTreat = function TrickAndTreat() {
      _classCallCheck(this, TrickAndTreat);
  ...
  /***/
  function srcAppSharedModelsLevelModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSharedServicesLocalStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LocalStorageService = /*#__PURE__*/function () {
      ...
      _createClass(LocalStorageService, [{
        key: "setDataToStore",
        value: function setDataToStore(data) {
          localStorage.setItem(this.storageName, JSON.stringify(data));
        }
      }, {
        key: "getStoredData",
        value: function getStoredData() {
          var storedData = localStorage.getItem(this.storageName);
