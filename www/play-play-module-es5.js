...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["play-play-module"], {
    ...
    var ChallengesComponent = /*#__PURE__*/function () {
      ...
      _createClass(ChallengesComponent, [{
        ...
        value: function getRandomChallenge(choice) {
          this.choice = choice; // this.challengesList$ = challengesList;

          this.challengesApiService.getChallengesList().subscribe(function (data) {
            var challenges = data;
            console.log('challenges in challenge component== ', challenges); // => { tricks: Array(3), treats: Array(3) }

            var list = Object.keys(challenges).forEach(function (key, index) {
              console.log('KEY= ', key, 'OBJ= ', challenges[key]); // KEY=  tricks OBJ=  (3) [{…}, {…}, {…}]
              // KEY=  treats OBJ=  (3) [{…}, {…}, {…}]
            });
          });

          if (this.choice === 'treat') {
            var randomTreat = this.treats[Math.floor(Math.random() * this.treats.length)];
  ...
  function srcAppPlayUserStatsUserStatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserStatsComponent = /*#__PURE__*/function () {
      function UserStatsComponent(userStatsService, geolocService, keyvaluepipe) {
      ...
      _createClass(UserStatsComponent, [{
        ...
        value: function setStats() {
          ...
          this.levels = this.userStatsService.displayAllCardsWithState(this.currentLevel); // this.setCardsState(this.currentLevel);
          // savedAddresses
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_2__["UserStatsService"], _shared_services_geoloc_service__WEBPACK_IMPORTED_MODULE_3__["GeolocService"], _shared_pipes_keyvalue_keyvalue__WEBPACK_IMPORTED_MODULE_4__["KeyvaluePipe"]])], UserStatsComponent);
    /***/
  },
