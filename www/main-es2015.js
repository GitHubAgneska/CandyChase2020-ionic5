...
/* harmony import */ var _play_services_http_error_handler_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./play/services/http-error-handler.service */ "./src/app/play/services/http-error-handler.service.ts");
...
/* harmony import */ var _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/native-geocoder/ngx */ "./node_modules/@ionic-native/native-geocoder/ngx/index.js");
...
/* harmony import */ var _play_services_message_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./play/services/message.service */ "./src/app/play/services/message.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _play_services_http_error_handler_service__WEBPACK_IMPORTED_MODULE_4__["HttpErrorHandler"],
            _play_services_message_service__WEBPACK_IMPORTED_MODULE_20__["MessageService"],
...
let HomeComponent = class HomeComponent {
    constructor(router, userStatsService) {
        this.router = router;
        this.userStatsService = userStatsService;
...
let ChallengesApiService = class ChallengesApiService {
    ...
    getChallengesList() {
        return this.httpClient.get(this.challengesListUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => {
...
let GeolocService = class GeolocService {
    ...
    addBounds(bounds) {
        this.geolocation.getCurrentPosition().then((res) => {
            leaflet__WEBPACK_IMPORTED_MODULE_3__["rectangle"](bounds, { color: '#00000', weight: 1 })
                .addTo(this.map);
            this.map.fitBounds(bounds);
        }).catch((error) => {
...
let UserStatsService = class UserStatsService {
    ...
    /*   this.levels.forEach(item => {
          ...
          return (this.allCards.push(item.levelCard));
        });
        return this.allCards; */
    // saved addresses ---------------------------------------------------------
