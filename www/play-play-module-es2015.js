...
let UserStatsComponent = class UserStatsComponent {
    constructor(userStatsService, geolocService, keyvaluepipe) {
        this.userStatsService = userStatsService;
        this.geolocService = geolocService;
        this.keyvaluepipe = keyvaluepipe;
    ...
    setStats() {
        ...
        console.log('levelName-------', 'ID=', this.currentLevel.idLevel, 'NAME=', this.currentLevel.levelName, 'ISACTIVE?==', this.currentLevel.isActive, this.currentLevel.levelCardName, this.currentLevel.levelImg);
        this.levels = this.userStatsService.displayAllCardsWithState(this.currentLevel);
        // this.setCardsState(this.currentLevel);
        // savedAddresses
    }
};
