...
let CandyListComponent = class CandyListComponent {
    constructor(candyApiService, userStatsService, shortenString, toastController, router, activatedRoute) {
        this.candyApiService = candyApiService;
        this.userStatsService = userStatsService;
        this.shortenString = shortenString;
...
let ChallengesComponent = class ChallengesComponent {
    constructor(activatedRoute, userStatsService, challengesApiService, toastController, location, router) {
        this.activatedRoute = activatedRoute;
        this.userStatsService = userStatsService;
