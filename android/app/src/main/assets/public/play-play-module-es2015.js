...
/* harmony import */ var _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/services/user-stats.service */ "./src/app/shared/services/user-stats.service.ts");
...
let CandyListComponent = class CandyListComponent {
    constructor(candyApiService, userStatsService, shortenString, toastController, router) {
        this.candyApiService = candyApiService;
        this.userStatsService = userStatsService;
        this.shortenString = shortenString;
...
CandyListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_candy_api_service__WEBPACK_IMPORTED_MODULE_2__["CandyApiService"],
        _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_5__["UserStatsService"],
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/user-stats.service */ "./src/app/shared/services/user-stats.service.ts");
/* harmony import */ var _services_challenges_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/challenges-api.service */ "./src/app/play/services/challenges-api.service.ts");
...
let ChallengesComponent = class ChallengesComponent {
    constructor(activatedRoute, userStatsService, challengesApiService) {
        this.activatedRoute = activatedRoute;
        this.userStatsService = userStatsService;
    ...
    getRandomChallenge(choice) {
        ...
        if (this.choice === 'treat') {
            const myList = this.retrieveTreatsList();
            console.log('MY LIST==', myList);
            // tslint:disable-next-line: prefer-for-of
        }
        else {
            const myList2 = this.retrieveTricksList();
...
ChallengesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        ...
        _services_challenges_api_service__WEBPACK_IMPORTED_MODULE_4__["ChallengesApiService"]])
], ChallengesComponent);
...
let MapComponent = class MapComponent {
    constructor(geolocService, toastController, userStatsService) {
...
/* harmony import */ var _services_level_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/level-api.service */ "./src/app/play/services/level-api.service.ts");
...
let UserStatsComponent = class UserStatsComponent {
    constructor(userStatsService, levelApiService, geolocService, keyvaluepipe) {
        this.userStatsService = userStatsService;
...
UserStatsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_services_user_stats_service__WEBPACK_IMPORTED_MODULE_2__["UserStatsService"],
        _services_level_api_service__WEBPACK_IMPORTED_MODULE_5__["LevelApiService"],
